...
export default class RiddleParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `RiddleParser.ifStmt`.
	 * @param ctx the parse tree
	 */
	enterIfStmt?: (ctx: IfStmtContext) => void;
	/**
	 * Exit a parse tree produced by `RiddleParser.ifStmt`.
	 * @param ctx the parse tree
	 */
	exitIfStmt?: (ctx: IfStmtContext) => void;
	/**
	 * Enter a parse tree produced by `RiddleParser.whileStmt`.
	 * @param ctx the parse tree
	 */
	enterWhileStmt?: (ctx: WhileStmtContext) => void;
	/**
	 * Exit a parse tree produced by `RiddleParser.whileStmt`.
	 * @param ctx the parse tree
	 */
